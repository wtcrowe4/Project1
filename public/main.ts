...
let deal = () => {
    ...
    playerCard1.src = `assets/cards/${DECK[0]}.png`
    let playerCard2 = document.getElementById('playerCard2') as HTMLImageElement
    playerCard2.src = `assets/cards/${DECK[2]}.png`
...
let dealerShows = () => {
    ...
    dealerCard1.src = `assets/cards/${DECK[1]}.png`
    let dealerCard2 = document.getElementById('dealerCard2') as HTMLImageElement
    dealerCard2.src = `assets/cards/${DECK[3]}.png`
...
//Cleaner game code
//Button assignment
let DealBtn = document.getElementById('dealbtn') as HTMLButtonElement
